...
<body>
	...
	<form method="POST" action="cadastro_action.php" class='espacamento'>
    <h1>FAÇA O CADASTRO DO FUNCIONÁRIO</h1> <br>
		<div id='erro'></div>
		<div id='acerto'></div>

		<div class="flutuacao">
                <input name="nome" type="text" id="usuario" placeholder=" " required>
                <label id="labelUsuario" for="usuario">Digite Seu Nome Completo </label>
        </div>

		<div class="flutuacao">
                <input name="telefone" type="tel" id="telefone" placeholder=" " required>
                <label id="labelTelefone" for="telefone" pattern="\([0-9]{2}\)[9]{1}[0-9]{4}-[0-9]{4}"
                    max-leght="11">Digite seu telefone</label>
        </div>

		<div class="flutuacao">
                <input name= "salario" type="text" id="salario" placeholder=" " required>
                <label id="labelSalario" for="salario">Salário</label>
		</div>

		<div class="flutuacao">
                <input name="cpf" type="text" id="campo_cpf" placeholder="" required>
                <label id="labelCpf" for="cpf">Digite seu CPF</label>
        </div>

		<div class="flutuacao">
                <input type="text" id="email" name="email" placeholder="" required>
                <label id="labelEmail" for="email">Digite um Email Válido</label>
        </div>
